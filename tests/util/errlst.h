...
#if !defined(TESTS_UTIL_ERRLST_H)
#define TESTS_UTIL_ERRLST_H
...
bool errlstcontains(const ErrList *haystack, const Error needle);


#endif /* !defined(TESTS_UTIL_ERRLST_H) */

...
| mostlyclean      | `make tidy` and delete compiled binaries.              |
| clean            | `make mostlyclean` and delete files generated by Make. |
| mrproper         | `make clean` and delete caches and coverage data.      |
